...
class CodeMirrorTernService {
  ...
  requestCallback(error: any, data: any, cm: CodeMirror.Editor, resolve: any) {
    ...
    CodeMirror.on(obj, 'select', (cur: any, node: any) => {
      // TODO CodeMirror.on(obj, 'select'
      console.log(`CodeMirror.on(obj, 'select'`, cur, node)
      // this.active = cur
      // this.remove(tooltip)
      ...
      //   CodeMirror.on(cm, 'keyHandled', (cm, keyboardEvent) => {
      //     // TODO CodeMirror.on(cm, 'keyHandled'
      //     console.log(`CodeMirror.on(cm, 'keyHandled'`)
      //     // if (
  ...
  tempTooltip(cm: CodeMirror.Editor, content: HTMLElement | string) {
    ...
    CodeMirror.on(tip, 'mouseout', function (e: MouseEvent) {
      // TODO CodeMirror.on(tip, 'mouseout'
      console.log(`CodeMirror.on(tip, 'mouseout'`)
