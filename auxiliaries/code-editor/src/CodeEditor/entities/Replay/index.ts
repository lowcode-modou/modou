...
import { Diff, applyChange, diff as deepDiff, revertChange } from 'deep-diff'
...
export abstract class ReplayEntity<T> {
  private readonly diffMap: any
  private undoManager: UndoManager
  protected entity: T
  private readonly replayEntityType: ENTITY_TYPE
  logs: any[] = []
