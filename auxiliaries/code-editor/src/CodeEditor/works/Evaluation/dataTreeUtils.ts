...
/**
 * This method accept an entity object as input and if it has __config__ property
 * than it moves the __config__ to object's prototype
 */
export function createNewEntity(entity: UnEvalTreeEntityObject) {
  if (!entity || !Reflect.has(entity, '__config__')) {
    return entity
  }
...
/**
 * This method takes unevaltree received from mainThread as input and return a
 * new unEvalTree with each entity config moved to entity object's prototype.
...
/**
 * This method loops through each entity object of dataTree and sets the entity config
 * from prototype as object properties.
