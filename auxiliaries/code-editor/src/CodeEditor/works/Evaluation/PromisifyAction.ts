...
import { EVAL_WORKER_ACTIONS } from '@modou/code-editor/CodeEditor/utils/DynamicBindingUtils'
import {
  EvalResult,
  createGlobalData,
} from '@modou/code-editor/CodeEditor/works/Evaluation/evaluate'
import { dataTreeEvaluator } from '@modou/code-editor/CodeEditor/works/Evaluation/evaluation.worker'
...
export const promisifyAction = async (
  ...
  return new Promise((resolve, reject) => {
    ...
    const subRequestId = uniqueId(`${workerRequestIdCopy}_`)
...
export const confirmationPromise = (
  requestId: string,
  func: any,
  name: string,
  ...args: any[]
