...
export const parseObject = (schema: JsonSchema7ObjectType & { default?: Record<string, any> }) => {
  let defaultObject: Record<string, any> | symbol = isObject(schema.default as any) ? cloneDeep(schema.default!) : DEFAULT_TO_EMPTY
